...
namespace ShapeAnimator.View.Shapes.Decorators
{
    ...
    /// </summary>
    public class VerticalBarDecorator : Decorator
    {
        /// <summary>
        ...
        public VerticalBarDecorator(Shape shape, int width, int height) : base(shape, width, height)
        {
        }
        ...
        {
            base.Paint(graphics);
            Brush barBrush = new SolidBrush(Color.Black);
